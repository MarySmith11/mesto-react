    ...
    return (
        ...
        >
            <div className="form__text-wrap">
                <input required type="text" onChange={handleNameChange} name="name" className="form__text form__text_type_title-name" placeholder="Название"
                    id="place-title-input" minLength="2" maxLength="30" />
                <span className="form__error place-title-input-error"></span>
            </div>
            <div className="form__text-wrap">
                <input required type="url" onChange={handleLinkChange} name="link" className="form__text form__text_type_link"
